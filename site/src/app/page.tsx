          ...
          <FadeIn delay={0.2}>
            <div className="mx-auto mt-10 max-w-3xl">
              <CodeBlock
                lang="text"
                title="flow pipeline"
                code={`Router ── NetFlow ──► VPS port 2055/2056 ──► container
      ── nfcapd ──► nfsen-data/live/<router>/
      ── nfsend ──► nfsen-stat/live/<router>.rrd
...
# Change the password immediately (no restart needed)
